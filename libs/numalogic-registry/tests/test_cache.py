...
from nlregistry import LocalLRUCache, ArtifactData, ArtifactCache
from nlregistry.artifact import _apply_jitter
...
class TestLocalLRUCache(unittest.TestCase):
    ...
    def test_multithread(self):
        ...
        threads = [
            Thread(
                target=cache_reg.save,
                args=(f"key_{i}", ArtifactData(model, dict(key_idx=i), {})),
            )
