...
from nlregistry.artifact import ArtifactManager, ArtifactCache, ArtifactData
    ...
    def save(
        ...
        **metadata: META_VT,
        ...
        self.__save_item(
            table,
            part_key,
            self._construct_version_key(sort_key, version=version),
            artifact_data,
        )
        ...
        if stale_version > 0:
            ...
            self.__delete_item(
                table,
                part_key,
                self._construct_version_key(sort_key, version=stale_version),
            )
            ...
            if version == artifact_data.extras.get("version"):
                ...
                if artifact_data_prev and prev_version != "0":
                    ...
                    prev_item = self._pack_artifact_data(
                        artifact_data_prev.artifact,
                        prev_version,
                        **artifact_data_prev.metadata,
                    )
                    self.__save_item(
                        table,
                        part_key,
