...
from nlregistry import RedisRegistry, LocalLRUCache, ArtifactData
...
class TestRedisRegistry(unittest.TestCase):
    ...
    def test_load_latest_model_twice(self):
        ...
        self.assertEqual("test_registry", artifact_data_1.extras["source"])
    ...
    def test_load_latest_cache_ttl_expire(self):
        ...
        self.assertEqual("test_registry", artifact_data_2.extras["source"])
    ...
    def test_multiple_save(self):
        ...
        self.assertEqual("test_registry", artifact_data.extras["source"])
