...
class SparsityGenerator:
    """
    Introduces sparsity to data by reassigning certain rows and columns in the dataframe to value of 0 (based on sparsity ratio).
    """
    ...
    def generate_sparsity(self):
        ...
        # based on sparsity ratio generating the rows to which the data is going to be imputed with 0
