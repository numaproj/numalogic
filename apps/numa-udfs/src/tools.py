...
from nlregistry import ArtifactManager, ArtifactData
from numalogic.tools.exceptions import RedisRegistryError
from numalogic.tools.types import KEYS, redis_client_t
from src._config import StreamConf
from src._logger import configure_logger
from src.entities import StreamPayload, TrainerPayload
...
def _load_artifact(
    ...
    Args:
        ...
        model_registry: test_registry where model is stored.
    ...
    if payload.artifact_versions:
        ...
        logger.debug(
            ...
            "if one present in the test_registry"
        )
        load_latest = True
    try:
        if load_latest:
