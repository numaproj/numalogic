...
from nlregistry import RedisRegistry, ArtifactData
from src import PipelineConf
from src.entities import Header, TrainerPayload, Status, OutputPayload
...
def test_compute(udf, artifact):
    score, x_inferred = udf.compute(artifact.artifact, np.asarray(DATA["data"]))
